 ...
 <link rel="stylesheet" href="{{ asset('assets/plugins/datatables/jquery.dataTables.min.css')}}">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manajemen Navbar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-info"><i class="fa fa-plus">&nbspTambah Navbar</i></div>
                 <div class="card-body">
...
<script src="{{ asset('assets/plugins/datatables/jquery.dataTables.min.js')}}"></script>
    <script>
      ...
      var id = $(this).data('id');
          $.get("{{ route('navbar.index') }}" +'/' + id +'/edit', function (data) {
