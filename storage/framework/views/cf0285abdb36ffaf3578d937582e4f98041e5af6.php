...
<link rel="stylesheet" href="<?php echo e(asset('assets/plugins/datatables/jquery.dataTables.min.css')); ?>">
   ...
   <script src="<?php echo e(asset('assets/plugins/datatables/jquery.dataTables.min.js')); ?>"></script>
    ...
    $('#createNewKategori').click(function () {
      ...
      var id = $(this).data('id');
          $.get("<?php echo e(route('kategori.index')); ?>" +'/' + id +'/edit', function (data) {
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/webartikel/resources/views/artikel/kategori.blade.php ENDPATH**/ ?>